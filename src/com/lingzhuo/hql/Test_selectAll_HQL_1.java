...
/**
 * @ClassName: Test_selectAll_HQL_1
 * @Description: TODO(这里用一句话描述这个类的作用)
 * @author LHX
 * @date 2017年9月12日 下午5:14:49
 *
 */
public class Test_selectAll_HQL_1 {
	...
	public static void main(String[] args) {
	    ...
	    try {
			List<CustomerEntity> list=dao.selectAll_HQL_1("%J%", new BigDecimal(300));
